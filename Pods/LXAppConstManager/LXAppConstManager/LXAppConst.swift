...
/// 定义一下app经常用到的全局常量
public struct LXAppConst {

   ///根据高度来判断是否是带刘海的手机,也可以通过safaAreaInserts来判断
    public static let isIPhoneX    = (LXAppConst.screenH == CGFloat(812) || LXAppConst.screenH == CGFloat(896)) ? true : false
    public static var isIphone5    = LXAppConst.screenW == 320
    public static var isIphone6    = LXAppConst.screenW == 375
    public static var isIphone6p   = LXAppConst.screenW == 414
    ///bounds
    ...
    ///屏幕相比iPhone6的宽度比例
    public static let scale = LXAppConst.screenW / CGFloat(375.0)
}
